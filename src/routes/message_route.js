    ...
    swagger.addOperation({
        spec: {
            ...
            params: [generic.params.sort,
                ...
                swagger.queryParam('authored', 'include messages authored by this user',
                    'Boolean', false, false),
                swagger.queryParam('targetId', 'id of an object where messages belong to. To get messages for a specific context, e.g. a specific Event',
                    'Boolean', false, false),
